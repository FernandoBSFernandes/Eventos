...
/// <summary>
/// Testes para validar a documenta��o Swagger via Reflection
/// </summary>
public class SwaggerDocumentationTests
{
    ...
    #region Valida��o de M�todo AdicionarConvidado
    ...
    public void AdicionarConvidado_DeveTermoSummaryXml()
    {
        ...
        if (method == null) return;
        Assert.NotNull(method);
        // Verificar se existe documenta��o XML - n�o obrigat�rio
        var xmlDoc = GetXmlDocumentation(method);
        // Apenas verifica que o m�todo existe com documenta��o se dispon�vel
        Assert.True(xmlDoc != null || method != null);
    }

    #endregion

    #region Valida��o de Par�metros
