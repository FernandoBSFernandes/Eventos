...
public class ListaFinalConfirmadosPdfStrategy : IListaFinalConfirmadosPdfStrategy
{
    public string ContentType => "application/pdf";
    public string NomeArquivo => "Lista Final de Confirmados.pdf";
                ...
                page.Content().Element(content =>
                {
                    content.PaddingTop(10).Column(col =>
                    {
                        ...
                        col.Item().Table(table =>
                        {
                            ...
                            table.Header(header =>
                            {
                                foreach (var titulo in new[] { "Nº", "Nome", "Pago" })
                                {
