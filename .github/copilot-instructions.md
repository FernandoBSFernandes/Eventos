...
- O usuário prefere que sempre que houver criação ou edição de código, seja criado, executado os testes e criado novos casos de testes de carga e performance, caso necessário.
